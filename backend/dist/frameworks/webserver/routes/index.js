...
const routes = (app) => {
    ...
    app.use('/api/user', userAuthMid_1.default, checkUserStatus_1.default, (0, user_1.default)());
    app.use('/api/admin', adminAuthMid_1.default, (0, admin_1.default)());
    app.use('/api/chat', userAuthMid_1.default, checkUserStatus_1.default, (0, chat_1.default)());
    app.use('/api/message', userAuthMid_1.default, checkUserStatus_1.default, (0, message_1.default)());
    app.use('/api/notification', userAuthMid_1.default, checkUserStatus_1.default, (0, notification_1.default)());
};
